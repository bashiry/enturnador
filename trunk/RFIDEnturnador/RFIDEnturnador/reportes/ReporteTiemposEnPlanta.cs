...
{
    public partial class ReporteTiemposEnPlanta : Form
    {
        private EnturnadorLIB.Reportes.Reportes objReporte;
        DataTable dt;

        public ReporteTiemposEnPlanta()
        {
            InitializeComponent();
        }

        private void ReporteTiemposEnPlanta_Load(object sender, EventArgs e)
        {
        ...
        private void Exportar()
        {
            ...
            try
            {
                ...
                strHora = strHora.Replace(".", "");
                string nombre = "ReporteTiempoEnPlanta_" + strHora + ".xls";
            ...
            catch (Exception ex)
            {
                ...
                objUtil.LogError("ReporteTiempoEnPlanta", "Exportar", ex.Message, inner, CGlobal.IdUsuario);
            }
        }

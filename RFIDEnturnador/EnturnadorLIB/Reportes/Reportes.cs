    ...
    public class Reportes
    {
        ...
        public DataTable GetReporteCiclosIncompletos(Hashtable hashFiltros)
        {
            ...
            {                
                ...
                {
                    if ((placa == dt.Rows[i + 1]["placa"].ToString()) && (placa == dt.Rows[i + 2]["placa"].ToString()) && (placa == dt.Rows[i + 3]["placa"].ToString()) && (placa == dt.Rows[i + 4]["placa"].ToString()))
                    {
        ...
        public DataTable GetReporteTiemposEnPlanta(Hashtable hashFiltros)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {                    
                    ...
                    if (dt.Rows[i]["placa"].ToString() == placaAnterior)
                    {
                        dr = dtTiempo.NewRow();

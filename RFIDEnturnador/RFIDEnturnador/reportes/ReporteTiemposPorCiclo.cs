...
{
    public partial class ReporteTiemposPorCiclo : Form
    {
        private EnturnadorLIB.Reportes.Reportes objReporte;
        DataTable dt;

        public ReporteTiemposPorCiclo()
        {
            InitializeComponent();
        }

        private void ReporteTiemposPorCiclo_Load(object sender, EventArgs e)
        {
        ...
        private void GenerarReporte()
        {
            ...
            this.dt = this.objReporte.GetReporteTiemposPorCiclo(filtros);
